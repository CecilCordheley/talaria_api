...
use Exception;
 class Service{
    private $attr=["idService"=>'',"nomService"=>'',"descService"=>'',"createAt"=>'',"isActiv"=>'',"Entreprise"=>'',"uuidService"=>''];
...
$entity->nomService=$element["nomService"];
$entity->descService=$element["descService"];
$entity->createAt=$element["createAt"];
$entity->isActiv=$element["isActiv"];
$entity->Entreprise=$element["Entreprise"];
